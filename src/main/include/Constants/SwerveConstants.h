...
inline constexpr units::meter_t WHEELBASE_WIDTH = 23_in;
inline constexpr units::meter_t WHEELBASE_LENGTH = 23_in;
...
inline constexpr units::meter_t BUMPER_THICKNESS = 2.75_in;
...
inline constexpr units::turn_t FL_ENC_OFFSET =  0.168212890625_tr;
inline constexpr units::turn_t FR_ENC_OFFSET = -0.01123046875_tr;
inline constexpr units::turn_t BL_ENC_OFFSET = -0.49169921875_tr;
inline constexpr units::turn_t BR_ENC_OFFSET = -0.20166015625_tr;
