...
Auto3PieceRightBlue::Auto3PieceRightBlue() 
{
  AddCommands(
    ...
    CmdDriveToPoint(1.5_m, -1.5_m, 0_deg, 4_mps, false, 5_s),
    ...
    CmdDriveToPoint(3.7_m, -1.4_m, -60_deg, 4_mps, false, 5_s),
    ...
    frc2::ParallelCommandGroup(
    CmdClawActivate(-1.0),
    CmdDriveToPoint(6_m, -0.6_m, -120_deg, 2_mps, false, 3_s)
    ),
    ...
    CmdDriveToPoint(4.2_m, -2.3_m, -120_deg, 2_mps, false, 3_s),
    ...
    //CmdDriveToPoint(3.8_m, -2.41_m, -120_deg, 1_mps, true, 2_s),
    ...
    CmdDriveToPoint(6.85_m, -0.0_m, -127_deg, 1_mps, true, 2_s),
    CmdClawActivate(-1.0),

    //Go to reef
    CmdDriveToPoint(4.5_m, -1.6_m, -120_deg, 4_mps, false, 3_s),
